...
|--------------|-------------|-------------------|--------------|-----------------|
| [Guardian News Aggregator](https://github.com/josephburgess/news-summary-challenge) | A web app for aggregating and filtering articles from the Guardian API. Utilises Pegasus Newsroom API to generate summaries of articles. | JavaScript, HTML, CSS, Jest | Build knowledge in JavaScript web apps, in particular with API calls and asynchronous programming & promises. | 2 days |
